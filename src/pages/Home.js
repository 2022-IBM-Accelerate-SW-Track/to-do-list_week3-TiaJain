...
class Home extends Component {
  ...
  addTodo = (todo) => {
    const contentExists = this.state.todos.find(t => t.content === todo.content);
    //const dateInvalid = this.state.todos.find(t => t.due === "Invalid Date");
    //const dateNull = this.state.todos.find(t => t.due === null);
    if (contentExists || this.state.due === "Invalid Date" || this.state.due === null){ return }


    // if the above if statement errors, try this: if (exists || todo.duedate == null || todo.duedate === "Invalid Date"){ return }
